...
**Shiny is easy to write**: As Shiny is built on R, it is very easy to write and understand. This is in contrast to HTML and JavaScript which can becomine quite messy.
