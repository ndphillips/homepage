...
You will have the opportunity to pump 15 balloons. Different balloons have different popping points and you never know exactly when each balloon will pop. However, you know for sure that the maximum possible number of pumps for a balloon is a certain value (e.g.; 50).
...
bart.display(1, 5, 0, saveballoon = TRUE, balloons.n = 15, max.pumps = 50)
bart.display(1, 40, 5, pop = TRUE, balloons.n = 15, max.pumps = 50)
```

## Play ShinyBART

You can play one version of the game here: [https://econpsychbasel.shinyapps.io/ShinyBART/](https://econpsychbasel.shinyapps.io/ShinyBART/)
