...
VisualResume::VisualResume(
  ...
  interests = list("Programming" = c(rep("R", 20), rep("Python", 1), rep("JavaScript", 2), "MatLab", "asdf"),
                   "Statistics" = c(rep("Dec Trees", 10), rep("Bayesian", 5), rep("Regression", 3), rep("Markov DP")),
                   "Research" = c(rep("Search", 10), rep("Dec Making", 5), rep("RI Learning", 3), rep("Competition", 6)))
)
```
...
VisualResume::VisualResume(
  ...
  bottom = data.frame(title = c("G", "H", "I", "J", "K", "L", "M", "N"),
                      ...
                      point.x = c(2006, 2009.7, 2010.2, 2014.8, 2015.1, 2015.5, 2016.3, 2016.8)),
  milestones = data.frame(title = c("M1", "M2", "M3"),
                          subtitle = c("2005", "2010", "2014"),
                          date = c(2005.5, 2010.9, 2014.5)),
  events = data.frame(year = c(2016, 2015, 2014, 2013, 2012),
