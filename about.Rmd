...
VisualResume::VisualResume(
  titles.left = c("Nathaniel D. Phillips, PhD.", "R, Data, and Decision Science", "*Built with love in R using the InfoResume package (www.ndphillips.github.io/VisualResume.html)"),
  ...
  timeline = data.frame(title = c("Grinnell College", "Ohio U", "U of Basel", "MPIB", "U of Konstanz", "U of Basel", "Musician's Friend", "Statistics", "Research Methods", "Information Search", "R", "R", "R", "R"),
                   ...
                   end = c(2005.5, 2010.9, 2014.5, 2014.6, 2016, 2017, 2006.5, 2010, 2011, 2015.3, 2015.3, 2015.9, 2016.6, 2017),
