...
VisualResume::VisualResume(
  ...
  events = data.frame(year = c(2017.3, 2016, 2015, 2014, 2013, 2012),
                      title = c("Phillips et al. (in press). FFTrees: A toolbox to create [...]\n fast-and-frugal decision trees. Judgment and Decision Making",
...
- <a href="media/Phillips_Resume_A.pdf#" class="download" title="Download resume as PDF (Updated July, 2017)">Download Resume as PDF (Updated July, 2017)</a>


# Publications

Phillips, N. D., Neth, H., Woike, J., & Gaissmaier W. (*in press*). FFTrees: An R package to create, visualise, and evaluate fast-and-frugal decision trees. *Judgment and Decision Making*
